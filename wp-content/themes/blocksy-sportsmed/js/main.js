...
jQuery(document).ready(function ($) {
  ...
  if ($("#gform_next_button_3_81").length) {
    var buttonHTML = '<a id="gform-get-started-now-button" href="/get-started-now/" type="button" class="gform_previous_button gform-theme-button gform-theme-button--secondary button">&larr;&nbsp; Find a SportsMed</a>';
