<?php
/*
Plugin Name: WPSEO to ASL Syncer 2.2
Plugin URI: https://www.openai.com/
Description: An enhanced plugin to sync WPSEO Locations data with Agile Store Locator data and includes a dry run preview.
Version: 2.2
Author: ChatGPT
